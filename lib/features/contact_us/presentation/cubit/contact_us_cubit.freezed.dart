...
class _Error implements ContactUsState {
...
@override
String toString() {
  return 'ContactUsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ContactUsStateCopyWith<$Res> {
